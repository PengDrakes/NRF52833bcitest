...
void nus_data_handler(ble_nus_evt_t * p_evt)
{
    ...
    if (p_evt->type == BLE_NUS_EVT_RX_DATA)
    {
        ...
        if (m_nus_notifications_enabled && (m_conn_handle != BLE_CONN_HANDLE_INVALID))
        {
            uint16_t tx_len = p_evt->params.rx_data.length;
    ...
    else if (p_evt->type == BLE_NUS_EVT_COMM_STARTED)
    {
        ...
        printf("NUS notify enabled\r\n");
    }
    else if (p_evt->type == BLE_NUS_EVT_COMM_STOPPED)
    {
        m_nus_notifications_enabled = false;
        printf("NUS notify disabled\r\n");
    }
...
//						xSemaphoreGive(enter_low_power_sem);
//       			spo2_wake_up=0;			
						printf("disconnect\r\n");
        ...
        case BLE_GAP_EVT_PHY_UPDATE_REQUEST:
        {
            ...
            {
                .rx_phys = BLE_GAP_PHY_AUTO,   //BLE_GAP_PHY_AUTO    BLE_GAP_PHY_2MBPS
        ...
        case BLE_GATTS_EVT_TIMEOUT:
            ...
            break;
				...
				case BLE_GAP_EVT_PHY_UPDATE:
						...
						//printf("PHY updated. TX PHY: %d, RX PHY: %d\r\n",p_ble_evt->evt.gap_evt.params.phy_update.tx_phy,lanya p_ble_evt->evt.gap_evt.params.phy_update.rx_phy);
