...
#define ATTENTION_FILTSEQ_ENABLE        0U
...
#define ATTENTION_DEBUG_SPECTRUM        0U
...
/*
 * Keep the attention algorithm running, but suppress per-window UART
 * traffic during the MAX30102 interference experiment.
 */
#define ATTENTION_RUNTIME_PRINT_ENABLE       0U
...
#if ATTENTION_RUNTIME_PRINT_ENABLE
...
#endif /* ATTENTION_RUNTIME_PRINT_ENABLE */
}
...
#if ATTENTION_DEBUG_QUALITY && ATTENTION_RUNTIME_PRINT_ENABLE
